...
| CA-15 | Um botão **"Publicar resultado final"**, sempre disponível, publica o resultado final (aplicando selos) e a seção "Resultado final" passa a ser exibida ao proponente conforme o CA-12. Publicar o final sem preliminar publicado permanece válido. |
